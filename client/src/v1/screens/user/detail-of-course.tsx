...
import {InsideCoursePreviewPart} from "../../../v2/user/courses/screen/InsideCoursePreviewPart.tsx";
                ...
                <>
                    <div>
                        <div className='w-full h-[250px] bg-[#333333]'>
                            <div
                                className='max-w-[1536px] mx-auto pl-[10%] pr-[5%] pt-[30px] flex justify-center items-start'>
                      ...
                      >
                        {courseData?.link}
                                    ...
                                    <InsideCoursePreviewPart courseId={courseData.id}/>
                                    ...
                                    <div className='w-full'>
                                        ...
                                        <div className='mt-[10px] flex justify-center items-center gap-[20px]'>
                                            <div
                                                className='border border-[#ccc] w-[20%] h-full flex flex-col justify-center items-center p-[10px_15px]'>
                            ...
                            <div className='max-w-[1536px] mx-auto pl-[10%] pr-[5%] pt-[20px]'>
                                ...
                                <div className='flex justify-between items-center w-full flex-wrap pb-[80px]'>
                                    ...
                                    <div
                                        className='itemCourseRelated flex justify-start items-center gap-[5px] flex-row py-[10px] w-[90%]'>
                                        {dataRelatedCourse &&
                                            trackingIndex === 1 &&
                                            dataRelatedCourse.length > 0 &&
