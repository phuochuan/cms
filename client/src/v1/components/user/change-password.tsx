...
import { changePasswordSchema } from "../../schemas/change-password-schema.ts";
import {
    Form,
    FormControl,
    FormField,
...
import PasswordInput from "../shared/input-password.tsx";

import { handleChangePassword } from "../../service/user.ts";
